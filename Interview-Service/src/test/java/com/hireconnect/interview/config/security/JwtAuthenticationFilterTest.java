package com.hireconnect.interview.config.security;
...
class JwtAuthenticationFilterTest {
    ...
    void shouldAuthenticateValidBearerToken() throws ServletException, IOException {
        ...
        request.addHeader("Authorization", "Bearer " + tokenFor("7", "RECRUITER"));
        ...
        assertThat(authentication.getAuthorities()).extracting("authority").containsExactly("ROLE_RECRUITER");
    }
